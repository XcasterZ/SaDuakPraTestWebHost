...
<body>
    ...
    <script>
        ...
        function buyNow() {
            ...
            if (LoginAuth === sellId) {
                alert('คุณไม่สามารถซื้อสินค้าของตัวเองได้'); // แจ้งเตือนหากเป็นผู้ขาย
        ...
        addCartButton.addEventListener('click', function(event) {
            ...
            if (LoginAuth === sellId) {
                alert('คุณไม่สามารถเพิ่มสินค้าของตัวเองในตะกร้าได้'); // แจ้งเตือนหากเป็นผู้ขาย
                event.preventDefault(); // หยุดการส่งฟอร์ม
            } else {
                // ทำการเพิ่มในตะกร้า
                // (ใส่โค้ดสำหรับเพิ่มในตะกร้า)
                console.log('เพิ่มสินค้าในตะกร้า:', productId);
            }
        });

        // ตรวจสอบปุ่มสิ่งที่อยากได้
        const addWishButton = document.querySelector('.addWish');
        addWishButton.addEventListener('click', function(event) {
            ...
            if (LoginAuth === sellId) {
                alert('คุณไม่สามารถบันทึกสินค้าของตัวเองในสิ่งที่อยากได้ได้'); // แจ้งเตือนหากเป็นผู้ขาย
                event.preventDefault(); // หยุดการส่งฟอร์ม
            } else {
                // ทำการเพิ่มในสิ่งที่อยากได้
                // (ใส่โค้ดสำหรับเพิ่มในสิ่งที่อยากได้)
                console.log('เพิ่มสินค้าในสิ่งที่อยากได้:', productId);
            }
        });
        const chatButton = document.querySelector('.chat'); // ดึงปุ่มแชทกับผู้ขาย
        const buyNowButton = document.querySelector('.buy_now'); // ดึงปุ่มซื้อตอนนี้
        if (LoginAuth === sellId) {
            addCartButton.disabled = true; // ปิดการใช้งานปุ่มเพิ่มในตะกร้า
            addWishButton.disabled = true; // ปิดการใช้งานปุ่มสิ่งที่อยากได้
            chatButton.disabled = true;
            buyNowButton.disabled = true; // ปิดการใช้งานปุ่มซื้อตอนนี้
        }
    </script>
